<?php
// Quick Basket - Home Page

$page_title = "Quick Basket";
?>
...
<body>
    ...
    <section class="hero-banner">
        ...
        <div class="hero-content">
            ...
            <div class="hero-text">
                ...
                <p>
                    On Fashion, Electronics, Mobiles,
    ...
    <section class="featured-products">
        ...
        <div class="section-heading">
            ...
            <a href="checkout.php">View All</a>
        </div>
        ...
        <div class="products-grid">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="price">
                        <span class="new-price">₹1,999</span>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="price">
                        <span class="new-price">₹1,799</span>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="price">
                        <span class="new-price">₹59,999</span>
                        <span class="old-price">₹79,999</span>
                    </div>
    ...
    <section class="testimonials">
        ...
        <div class="testimonial-container">
            ...
            <div class="testimonial-card">
                ...
                <p>
                    Great offers and secure payment system.
                    Highly recommended.
                </p>
            ...
            <div class="testimonial-card">
                ...
                <p>
                    Best online shopping platform with
    ...
    <section class="newsletter">
        ...
        <div class="newsletter-content">
            ...
            <p>
                Get updates about new products, special offers and exclusive discounts.
            </p>
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            ...
            <p>
                © <?php echo date("Y"); ?> Quick Basket. All Rights Reserved.
            </p>
